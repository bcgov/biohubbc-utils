...
DO $$
    DECLARE
        ...
        _taxonomy_id integer; -- used as an index in the loop, do not set
        _validation_config varchar := $v_s${"files":[{"name":"Elk_RESULTS","validations":[{"file_duplicate_columns_validator":{}},{"file_required_columns_validator":{"required_columns":["Study Area","Population Unit","Block ID/SU ID","Survey Start Date","Survey End Date","Survey Year","Survey Month","Survey Day","Total Survey Time","Total Survey Time Unit Code","Total Area Surveyed (km2)","Total Kilometers Surveyed (km)","Species Code","Parameter","Stratum","Observed","Estimated","Sightability Model","Sightability Correction Factor","SE","Coefficient of Variation (%)","Confidence Level (%)","Lower CL","Upper CL","Best Parameter Value Flag","Outlier SRB Blocks Removed","Marked Animals Observed","Total Marked Animals Available","Comments"]}}],"columns":[]}],"validations":[{"mimetype_validator":{"reg_exps":["text/csv","application/vnd.*"]}}]}$v_s$;
...
DO $$
    DECLARE
        _template_id integer; -- set after template is created
        _template_name varchar := 'Goat Summary Results';
        _template_version varchar := '2.0';
        _template_description varchar := 'Goat Summary Results';

        _taxonomy_ids integer[] := array[2062]; -- wild taxonomic IDs from elastic search
        _taxonomy_id integer; -- used as an index in the loop, do not set
        _validation_config varchar := $v_s${"files":[{"name":"Goat_RESULTS","validations":[{"file_duplicate_columns_validator":{}},{"file_required_columns_validator":{"required_columns":["Study Area","Population Unit","Block ID/SU ID","Survey Start Date","Survey End Date","Survey Year","Survey Month","Survey Day","Total Survey Time","Total Survey Time Unit Code","Total Area Surveyed (km2)","Total Kilometers Surveyed (km)","Species Code","Parameter","Stratum","Observed","Estimated","Sightability Model","Sightability Correction Factor","SE","Coefficient of Variation (%)","Confidence Level (%)","Lower CL","Upper CL","Best Parameter Value Flag","Outlier SRB Blocks Removed","Marked Animals Observed","Total Marked Animals Available","Comments"]}}],"columns":[]}],"validations":[{"mimetype_validator":{"reg_exps":["text/csv","application/vnd.*"]}}]}$v_s$;
...
DO $$
    DECLARE
        ...
        _template_version varchar := '2.0';
        _template_description varchar := 'Moose Summary Results';

        _taxonomy_ids integer[] := array[2065]; -- wild taxonomic IDs from elastic search
        _taxonomy_id integer; -- used as an index in the loop, do not set
        _validation_config varchar := $v_s${"files":[{"name":"Moose_RESULTS","validations":[{"file_duplicate_columns_validator":{}},{"file_required_columns_validator":{"required_columns":["Study Area","Population Unit","Block ID/SU ID","Survey Start Date","Survey End Date","Survey Year","Survey Month","Survey Day","Total Survey Time","Total Survey Time Unit Code","Total Area Surveyed (km2)","Total Kilometers Surveyed (km)","Species Code","Parameter","Stratum","Observed","Estimated","Sightability Model","Sightability Correction Factor","SE","Coefficient of Variation (%)","Confidence Level (%)","Lower CL","Upper CL","Best Parameter Value Flag","Outlier SRB Blocks Removed","Marked Animals Observed","Total Marked Animals Available","Comments"]}}],"columns":[]}],"validations":[{"mimetype_validator":{"reg_exps":["text/csv","application/vnd.*"]}}]}$v_s$;
...
DO $$
    DECLARE
        ...
        _template_version varchar := '2.0';
        _template_description varchar := 'Sheep Summary Results';

        _taxonomy_ids integer[] := array[23919,23921,23922,25929,23920]; -- wild taxonomic IDs from elastic search
        _taxonomy_id integer; -- used as an index in the loop, do not set
        _validation_config varchar := $v_s${"files":[{"name":"Sheep_RESULTS","validations":[{"file_duplicate_columns_validator":{}},{"file_required_columns_validator":{"required_columns":["Study Area","Population Unit","Block ID/SU ID","Survey Start Date","Survey End Date","Survey Year","Survey Month","Survey Day","Total Survey Time","Total Survey Time Unit Code","Total Area Surveyed (km2)","Total Kilometers Surveyed (km)","Species Code","Parameter","Stratum","Observed","Estimated","Sightability Model","Sightability Correction Factor","SE","Coefficient of Variation (%)","Confidence Level (%)","Lower CL","Upper CL","Best Parameter Value Flag","Outlier SRB Blocks Removed","Marked Animals Observed","Total Marked Animals Available","Comments"]}}],"columns":[]}],"validations":[{"mimetype_validator":{"reg_exps":["text/csv","application/vnd.*"]}}]}$v_s$;
