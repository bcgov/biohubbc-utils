...
export const build = async () => {
  ...
  const config: TemplateBuilderConfig = {
    output: {
      label: 'moose_aerial-general-recruitment-composition-survey',
      version: '2.1',
    ...
    sql: {
      ...
      name: 'Moose Aerial General Recruitment Composition Survey',
      version: '2.0',
      description: 'Moose Aerial General Recruitment Composition Survey',
      taxonIDs: ['2065']
    }
  };
